  ...
  const DescCollapse = (props) => {
    ...
    return (
      <div className={styles['description-content']}>
        <p className={styles['description']} style={{'WebkitLineClamp': isToggleOn === true ? 'initial' : 3}} dangerouslySetInnerHTML={{ __html: '<b>Definition:</b> ' + props.desc}}></p>
          ...
          <Col className={styles['table-col']} data-class="TableCol" xs={3}>
            ...
            <ul className={styles['table-ul']}>
              <li className={styles['table-li']}>
                <span className={styles['span-icon']}><AngleDownIcon/></span>{props.item.node.n}
              </li>
            </ul>
          </Col>
