...
const ICDCModel = () => {
  return <ContentBoxAbout>
    <ContentBoxText>
      ...
      <p>
        The Pediatric Cancer Data Commons (PCDC) works with leaders in in pediatric cancers to develop and apply uniform clinical data standards and facilitate the collection and linkage of data from many different sources and types.
      </p>
    </ContentBoxText>
    <ContentBoxHr/>
