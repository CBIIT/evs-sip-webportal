...
import PaginationController from '../../../components/PaginationsController/PaginationController'
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await fetch(
        `${baseUrl}/datamodel/search?keyword=${searchTerm}&model=CTDC&type=${tabState}&page=${currentPageState[tabState]}&pageSize=${pageSizeState[tabState]}`
      )
