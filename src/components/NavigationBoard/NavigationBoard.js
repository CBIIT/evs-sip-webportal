...
const NavigationBoard = () => {
  ...
  return (
    <Nav className="flex-column">
      ...
      <NavDropdown className={styles.navDropdown} title="Published Data Sources" id="nav-dropdown">
      ...
      <NavDropdown className={styles.navDropdown} title="Unpublished Data Sources" id="nav-dropdown">
