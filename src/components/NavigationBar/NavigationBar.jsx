...
const NavigationBar = () => {
  ...
  const login = e => {
    e.preventDefault();
    dispatch(setUser({name: 'mirandafm'}));
  }
  ...
  return (<Navbar className={styles.navbar} bg="dark" expand="lg" role="navigation">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav>
            ...
            <NavDropdown className={styles.dropdown} title="Data Model">
              ...
              }}>GDC</NavDropdown.Item>
              <NavDropdown.Item className={styles['dropdown-item']} as={Link} to={{
                pathname: '/datamodel',
                state: {
                  fromDataModel: 'ctdc'
                }
              }}>CTDC</NavDropdown.Item>
              <NavDropdown.Item className={styles['dropdown-item']} as={Link} to={{
                pathname: '/datamodel',
                state: {
                  fromDataModel: 'icdc'
                }
              }}>ICDC</NavDropdown.Item>
              <NavDropdown.Item className={styles['dropdown-item']} as={Link} to={{
                pathname: '/datamodel',
                state: {
                  fromDataModel: 'pcdc'
                }
              }}>PCDC</NavDropdown.Item>
            </NavDropdown>
            ...
            {isLoggedIn ? 
              <NavDropdown className={styles.dropdown} title={currentUser.name}>
                ...
                <NavDropdown.Item className={styles['dropdown-item']} as={Link} to='#'>Profile</NavDropdown.Item>
                <NavDropdown.Item className={styles['dropdown-item']} as={Link} to='/mainboard'>Dashboard</NavDropdown.Item>
                <NavDropdown.Item className={styles['dropdown-item']} onClick={logout}>Sign Out</NavDropdown.Item>
              </NavDropdown>
              : 
