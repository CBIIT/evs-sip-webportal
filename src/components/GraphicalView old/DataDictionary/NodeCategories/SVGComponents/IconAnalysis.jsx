    ...
    render() {
        return (
            <svg width="20px" height="21px" viewBox="0 0 20 21" version="1.1" xmlns="http://www.w3.org/2000/svg">
                ...
                <g id="icon_analysis" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    <path d="M10,0.498854962 C15.5225192,0.498854962 20,4.97633579 20,10.498855 C20,16.0207313 15.5225192,20.498855 10,20.498855 C4.47748082,20.498855 0,16.0213027 0,10.498855 C0,4.97640721 4.47683803,0.498854962 10,0.498854962 Z" id="Shape" fill="#FF7ABC" fillRule="nonzero"></path>
                    <g id="Group-9" transform="translate(10.000000, 10.500000) rotate(-90.000000) translate(-10.000000, -10.500000) translate(5.500000, 5.500000)" fill="#FFFFFF" fillRule="nonzero">
