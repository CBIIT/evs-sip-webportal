        ...
        return (
            <svg width="20px" height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg">
                ...
                <g id="icon_metadata" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <path d="M10,0 C15.5225192,0 20,4.47748082 20,10 C20,15.5218764 15.5225192,20 10,20 C4.47748082,20 0,15.5224478 0,10 C0,4.47755224 4.47683803,0 10,0 Z" id="Shape" fill="#F4B940" fill-rule="nonzero"></path>
